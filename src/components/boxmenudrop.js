    ...
    <div className="dropdown" onClick={handleToggle} ref={wrapperRef}>
      ...
      >
        <div className="drop-item">
          ...
          <a className="drop-link" href="mailto:sankaramdas@gmail.com">
            <img
              src={email}
              alt=""
            />
          ...
          <a className="drop-link" href="https://github.com/SANKARAMDAS">
            <img
              src={gh}
              alt=""
            />
          ...
          <a className="drop-link" href="https://www.linkedin.com/in/sankaramdas/">
            <img
              src={li}
              alt=""
            />
